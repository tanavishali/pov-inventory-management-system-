    ...
    <div style={{ animation: 'fadeIn 0.4s ease-out' }}>
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', borderBottom: '2px solid #e2e8f0', paddingBottom: '12px', marginBottom: '24px', flexWrap: 'wrap', gap: '16px' }}>
        <div style={{ display: 'flex', background: '#e2e8f0', padding: '5px', borderRadius: '12px', gap: '4px' }}>
          ...
          <button style={tabButtonStyle('health')} onClick={() => setActiveTab('health')}>
            <i className="fa-solid fa-network-wired" /> System & Health
          </button>
        </div>
      ...
      {/* ──────────────────────────────────────────────────────── */}
      {/* ── TAB CONTENT: SYSTEM CONTROLS & HEALTH ── */}
      {/* ──────────────────────────────────────────────────────── */}
      {activeTab === 'health' && (
        <div style={{ animation: 'fadeIn 0.3s ease-out' }}>
          
          {/* Microservices Health Status Nodes */}
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '20px', marginBottom: '28px' }}>
            
            {/* MongoDB Grid Node */}
            <div style={{ ...cardStyle, display: 'flex', alignItems: 'center', justifyStyle: 'stretch', gap: '16px' }}>
              <div style={{ width: '48px', height: '48px', borderRadius: '12px', background: '#dcfce7', color: '#10b981', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '22px' }}>
                <i className="fa-solid fa-database" />
              </div>
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <h4 style={{ fontSize: '14px', fontWeight: 800, color: '#0f172a' }}>MongoDB Primary Cluster</h4>
                  <span className="pulse-dot" style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#10b981' }} />
                </div>
                <div style={{ fontSize: '11.5px', color: '#64748b', marginTop: '3px' }}>Connected • Shards Operational</div>
                <div style={{ fontSize: '10.5px', color: '#94a3b8', marginTop: '6px', fontWeight: 600 }}>Active pool: 12 nodes</div>
              </div>
            </div>

            {/* Gateway verification API */}
            <div style={{ ...cardStyle, display: 'flex', alignItems: 'center', gap: '16px' }}>
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <h4 style={{ fontSize: '14px', fontWeight: 800, color: '#0f172a' }}>Platform Gateways</h4>
                  <span className="pulse-dot" style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#10b981' }} />
                </div>
                <div style={{ fontSize: '11.5px', color: '#64748b', marginTop: '3px' }}>Operational • Handshake OK</div>
                <div style={{ fontSize: '10.5px', color: '#94a3b8', marginTop: '6px', fontWeight: 600 }}>Avg SSL Ping: 9ms</div>
              </div>
            </div>

            {/* SMS Delivery Provider Gateway */}
            <div style={{ ...cardStyle, display: 'flex', alignItems: 'center', gap: '16px' }}>
              <div style={{ width: '48px', height: '48px', borderRadius: '12px', background: '#dcfce7', color: '#10b981', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '22px' }}>
              ...
              <div style={{ flex: 1 }}>
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                  <h4 style={{ fontSize: '14px', fontWeight: 800, color: '#0f172a' }}>SMS Gateway Dispatcher</h4>
                  <span className="pulse-dot" style={{ width: '8px', height: '8px', borderRadius: '50%', background: '#10b981' }} />
                </div>
                <div style={{ fontSize: '11.5px', color: '#64748b', marginTop: '3px' }}>Active • Dispatch queue empty</div>
                <div style={{ fontSize: '10.5px', color: '#94a3b8', marginTop: '6px', fontWeight: 600 }}>Delivery Rate: 99.8%</div>
              </div>
            </div>

          </div>

          {/* Core Hardware Metrics & Diagnostic Logging Panel */}
          <div style={{ display: 'grid', gridTemplateColumns: '1.2fr 1fr', gap: '24px' }} className="sa-grid-2">
            
            {/* Visual Hardware Telemetry Dials */}
            <div style={cardStyle}>
              <h3 style={{ fontSize: '16px', fontWeight: 800, color: '#0f172a', marginBottom: '6px', display: 'flex', alignItems: 'center', gap: '8px' }}>
                <i className="fa-solid fa-microchip" style={{ color: '#6366f1' }} /> Virtual Server Resource Dials
              </h3>
              <p style={{ fontSize: '12.5px', color: '#64748b', marginBottom: '28px' }}>
                Simulated real-time CPU, RAM and Thread allocations on the host cluster.
              </p>
              ...
              <div style={{ display: 'flex', justifyContent: 'space-around', alignItems: 'center', flexWrap: 'wrap', gap: '24px' }}>
                ...
                <div style={{ textAlign: 'center' }}>
                  <div style={{ position: 'relative', width: '90px', height: '90px', margin: '0 auto 10px' }}>
                    <svg width="90" height="90" viewBox="0 0 100 100">
                      ...
                      <circle cx="50" cy="50" r="40" fill="none" stroke="#6366f1" strokeWidth="8" strokeDasharray="251" strokeDashoffset="180" strokeLinecap="round" transform="rotate(-90 50 50)" />
                    </svg>
                    <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontWeight: 800, fontSize: '14px', color: '#0f172a' }}>28%</div>
                  </div>
                  <span style={{ fontSize: '12.5px', fontWeight: 800, color: '#475569' }}>CPU Load</span>
                </div>
                ...
                <div style={{ textAlign: 'center' }}>
                  <div style={{ position: 'relative', width: '90px', height: '90px', margin: '0 auto 10px' }}>
                    <svg width="90" height="90" viewBox="0 0 100 100">
                      <circle cx="50" cy="50" r="40" fill="none" stroke="#e2e8f0" strokeWidth="8" />
                      <circle cx="50" cy="50" r="40" fill="none" stroke="#0ea5e9" strokeWidth="8" strokeDasharray="251" strokeDashoffset="100" strokeLinecap="round" transform="rotate(-90 50 50)" />
                    </svg>
                    <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontWeight: 800, fontSize: '14px', color: '#0f172a' }}>60%</div>
                  </div>
                  <span style={{ fontSize: '12.5px', fontWeight: 800, color: '#475569' }}>RAM Alloc</span>
                </div>

                {/* API Response latency dial */}
                <div style={{ textAlign: 'center' }}>
                  <div style={{ position: 'relative', width: '90px', height: '90px', margin: '0 auto 10px' }}>
                    <svg width="90" height="90" viewBox="0 0 100 100">
                      <circle cx="50" cy="50" r="40" fill="none" stroke="#e2e8f0" strokeWidth="8" />
                      <circle cx="50" cy="50" r="40" fill="none" stroke="#10b981" strokeWidth="8" strokeDasharray="251" strokeDashoffset="210" strokeLinecap="round" transform="rotate(-90 50 50)" />
                    </svg>
                    <div style={{ position: 'absolute', top: '50%', left: '50%', transform: 'translate(-50%, -50%)', fontWeight: 800, fontSize: '14px', color: '#0f172a' }}>{dbLatency}ms</div>
                  </div>
                  <span style={{ fontSize: '12.5px', fontWeight: 800, color: '#475569' }}>API Latency</span>
                </div>

              </div>
            </div>

            {/* Diagnostic Console Logging Center */}
            <div style={cardStyle}>
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '14px' }}>
                <h3 style={{ fontSize: '16px', fontWeight: 800, color: '#0f172a', display: 'flex', alignItems: 'center', gap: '8px' }}>
                  <i className="fa-solid fa-terminal" style={{ color: '#0f172a' }} /> Core Diagnostic Logs
                </h3>
                {diagnosticState === 'idle' && (
                  <button onClick={runDiagnostics} style={{ border: 'none', background: '#0f172a', color: '#fff', fontSize: '11px', fontWeight: 700, padding: '5px 12px', borderRadius: '6px', cursor: 'pointer' }}>
                    Run Telemetry Test
                  </button>
                )}
                {diagnosticState === 'running' && (
                  <span style={{ fontSize: '11px', color: '#6366f1', fontWeight: 700 }}><i className="fa-solid fa-spinner fa-spin" /> Verifying...</span>
                )}
              </div>
              
              <div style={{ background: '#0f172a', border: '1px solid #1e293b', borderRadius: '12px', padding: '16px', height: '140px', overflowY: 'auto', boxSizing: 'border-box', fontFamily: "'Courier New', Courier, monospace" }}>
                {diagnosticState === 'idle' && (
                  <div style={{ color: '#94a3b8', fontSize: '11.5px', textAlign: 'center', paddingTop: '35px' }}>
                    Telemetry status ready. Run diagnostics above to ping all server handshakes.
                  </div>
                )}
                {(diagnosticState === 'running' || diagnosticState === 'success') && (
                  <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                    {diagnosticLogs.map((log, index) => (
                      <div key={index} style={{ color: log.includes('respond') || log.includes('Latency') ? '#34d399' : '#e2e8f0', fontSize: '11px', lineHeight: '1.4' }}>
