...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get all orders for the current tenant shop' }),
...
__decorate([
    (0, common_1.Post)(),
    (0, swagger_1.ApiOperation)({ summary: 'Place a new order in the current tenant shop' }),
    __param(0, (0, common_1.Req)()),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Update an order in the current tenant shop' }),
    __param(0, (0, common_1.Req)()),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Delete an order from the current tenant shop' }),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
