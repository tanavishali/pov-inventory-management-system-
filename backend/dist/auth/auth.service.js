...
let AuthService = class AuthService {
    ...
    async assertSubscriptionActive(user) {
        ...
        if (exp < today) {
            throw new common_1.UnauthorizedException('Your subscription has expired. Please contact the administrator to renew your plan.');
        }
    }
    async login(user) {
