...
let ProductsController = class ProductsController {
    ...
    async findAll(req, search, filter, sort) {
...
__decorate([
    (0, common_1.Get)(),
    (0, swagger_1.ApiOperation)({ summary: 'Get all products for the current tenant shop' }),
...
__decorate([
    (0, common_1.Patch)(':id'),
    (0, swagger_1.ApiOperation)({ summary: 'Update a product in the current tenant shop' }),
    __param(0, (0, common_1.Req)()),
...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Delete a product from the current tenant shop' }),
    __param(0, (0, common_1.Req)()),
    __param(1, (0, common_1.Param)('id')),
    __metadata("design:type", Function),
